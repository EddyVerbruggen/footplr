<template>
  <Page>
    <GridLayout rows="auto, auto, 230, auto, 2*, *" columns="auto, *" :class="'background-color-score-' + scoreClass"
      ...
      <GridLayout row="3" colSpan="2" columns="54, 76, *, 100" class="table" style="background-color: #011627; color: #fff">
      ...
      <ListView row="4" colSpan="2" for="(item, index) in measurements" @itemTap="onItemTap"
        ...
        <v-template>
          <GridLayout columns="54, 76, *, 100" class="row" v-bind:class="index % 2 === 0 ? 'row-odd' : 'row-even'">
